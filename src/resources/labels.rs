...
pub fn common_labels(
    ...
    labels.insert(
        "berg.norelect.ch/challenge".to_string(),
        instance.spec.challenge_ref.name.clone(),
    );
    labels.insert(
        "berg.norelect.ch/owner-id".to_string(),
        instance.spec.owner_id.clone(),
    );
...
pub fn namespace_labels(instance: &ChallengeInstance, ctx: &Context) -> BTreeMap<String, String> {
    ...
    labels.insert(
        "berg.norelect.ch/challenge-namespace".to_string(),
        instance
            .spec
            .challenge_ref
            .namespace
